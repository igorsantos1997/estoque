            ...
            $(function(){
                ...
                $("#modalConfirmSim").on("click",function(){
                    ...
                    if (nome=="excluir"){
                       ...
                       $.post("ajax/ajaxApagaClientePj.php",{codigo: $("#txtCodigoCliPj").val()}).done(function(result){
                            resetCampos();
                           resetFormClientePj();
                           if (result=="apagado"){
        ...
        <div class="form-row">
            <div class="form-group col-md-2">
                ...
                <div class="form-inline">
                    <input type="number" placeholder="Código" name="txtCodigoCliPj" id="txtCodigoCliPj" class="form-control w-75"><button id="btnFormAuxCliPj" class="btnLupa" type="button" data-toggle="modal" data-target="#modalBuscaClientePj"></button>
                </div>
            </div>
